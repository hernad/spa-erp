...
public class repIspOS_04Template extends repIspOSOrigTemplate {

  public repIspOS_04Template() {
    System.out.println("\nrepIspOS_04Template()\n");
    this.Section1.setDefault(ep.FIELD,"InvBr");
