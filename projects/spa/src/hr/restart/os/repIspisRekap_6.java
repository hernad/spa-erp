...
public class repIspisRekap_6 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisRekap_6() {
    ru.setDataSet(ds);
  }

  public repIspisRekap_6(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisRekap_6(indx++);
      }
