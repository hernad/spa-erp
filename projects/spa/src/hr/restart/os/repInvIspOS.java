...
public class repInvIspOS implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  _Main main;
...
//      isp = (ds.getBigDecimal("ISPPOTRAZUJE").add(ds.getBigDecimal("ISPDUGUJE").negate())).doubleValue();
 ...
 public String getLabelaListe()
  ...
  {
    if(poPripCORG)
      return "( po org. jedinici i "+tempOL+" s inventarskim brojem i pripadajuæim org. jedinicama )";
    else
