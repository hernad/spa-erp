...
public class repIspisAmor_4 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisAmor_4() {
    ru.setDataSet(ds);
  }

  public repIspisAmor_4(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisAmor_4(indx++);
      }
