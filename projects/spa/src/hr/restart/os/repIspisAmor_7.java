...
public class repIspisAmor_7 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisAmor_7() {
    ru.setDataSet(ds);
  }

  public repIspisAmor_7(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisAmor_7(indx++);
      }
...
//        rez = ru.getSomething(colname,dm.getKonta() ,"nazivkonta").toString().trim();
      ...
      case 1:
        colname[0] = "cgrupe";
        rez = ru.getSomething(colname,dm.getOS_Amgrupe() ,"zakstopa").toString().trim();
        rez = rez.substring(0,rez.indexOf('.')+3)+" %";
        rez.replace('.',',');
        break;
      case 2:
        colname[0] = "clokacije";
  ...
  {
    if(poPripCORG)
      return "( po org. jedinicama i " + tempOL +" s inventarskim brojem i pripadajuæim org. jedinicama )";
    else
      return "( po org. jedinicama i " + tempOL +" s inventarskim brojem )";
  }
