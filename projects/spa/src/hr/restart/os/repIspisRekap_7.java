...
public class repIspisRekap_7 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisRekap_7() {
    ru.setDataSet(ds);
  }

  public repIspisRekap_7(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisRekap_7(indx++);
      }
