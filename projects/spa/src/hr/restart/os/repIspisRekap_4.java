...
public class repIspisRekap_4 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisRekap_4() {
    ru.setDataSet(ds);
  }

  public repIspisRekap_4(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisRekap_4(indx++);
      }
