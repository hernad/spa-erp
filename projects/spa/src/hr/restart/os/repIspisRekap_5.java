...
public class repIspisRekap_5 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisRekap_5() {
    ru.setDataSet(ds);
  }

  public repIspisRekap_5(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisRekap_5(indx++);
      }
