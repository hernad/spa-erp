...
public class repIspisRekap_1BN implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisRekap_1BN() {
    ru.setDataSet(ds);
  }

  public repIspisRekap_1BN(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisRekap_1BN(indx++);
      }
  ...
  {
    if (lookupData.getlookupData().raLocate(dm.getOrgstruktura(),"CORG",ds.getString("corg")))
