...
public class repIspisAmor_1 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisAmor_1() {
    ru.setDataSet(ds);
  }

  public repIspisAmor_1(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisAmor_1(indx++);
      }
