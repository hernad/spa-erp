...
public class repIzKnjizKum implements sg.com.elixir.reportwriter.datasource.IDataProvider
{

  _Main main;
  DataSet ds = ispKnjiz.getQdsIspis();
  ...
  public repIzKnjizKum() {
    ru.setDataSet(ds);
  }

  public repIzKnjizKum(int idx) {
    ds.goToRow(idx);
  }
...
//    String rez = ru.getSomething(colname,dm.getKonta() ,"nazivkonta").toString().trim();
  ...
  {
    return ispKnjiz.sume[0];
  }

  public double getSumOsnPot()
  {
    return ispKnjiz.sume[1];
  }

  public double getSumIspDug()
  {
    return ispKnjiz.sume[2];
  }

  public double getSumIspPot()
  {
    return ispKnjiz.sume[3];
  }

  public double getSumSaldo()
  {
    return ispKnjiz.sume[4];
  }

  public String getPocDat()
  {
    StringBuffer sb = new StringBuffer(ispKnjiz.datumOd);
    sb.replace(2,3,".");
    sb.replace(5,6,".");
    return sb.toString();
  }
  ...
  {
    StringBuffer sb = new StringBuffer(ispKnjiz.datumDo);
    sb.replace(2,3,".");
    sb.replace(5,6,".");
    return sb.toString();
  }
