...
public class repIspisAmor_2 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisAmor_2() {
    ru.setDataSet(ds);
  }

  public repIspisAmor_2(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisAmor_2(indx++);
      }
 ...
 public String getLabelaListe()
  ...
  public String getNazOblikListe()
  {
    ru.setDataSet(ds);
    String rez="";
//    String dodatak ="   "+ getZakStopa() + " + " + getOdlStopa();
...
/*
  ...
  {
    if(oblikListe==1)
      return getZakStopa() + " + " + getOdlStopa();
    return "";
  }
}
