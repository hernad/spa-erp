...
public class repIspisAmor_6 implements sg.com.elixir.reportwriter.datasource.IDataProvider
{
  ...
  public repIspisAmor_6() {
    ru.setDataSet(ds);
  }

  public repIspisAmor_6(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        return new repIspisAmor_6(indx++);
      }
...
//        rez = ru.getSomething(colname,dm.getKonta() ,"nazivkonta").toString().trim();
  ...
  {
    if(poPripCORG)
      return "( po " + tempOL +" s inventarskim brojem s pripadajuæim org. jedinicama )";
    else
