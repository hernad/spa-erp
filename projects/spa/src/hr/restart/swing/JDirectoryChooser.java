...
public class JDirectoryChooser extends JComponent
{
    ...
    public JDirectoryChooser(FileSystemView view)
    {
        ...
        b.add(p, BorderLayout.EAST);
        b.add(bottom, BorderLayout.WEST);
        b.setBorder(BorderFactory.createEmptyBorder(3, 1, 1, 1));
   ...
   private void makeCurrentDirectoryVisible()
   {
    ...
    public int showDialog(Component parent)
    {
        ...
        dialog = new JraDialog(frame, title, true);
    ...
    private JButton approve = new JButton("Odaberi");
    private JButton cancel = new JButton("Poništi");
    ...
    private class FileRenderer extends DefaultTreeCellRenderer
    {
        ...
        {
            Component comp = super.getTreeCellRendererComponent(tree,node,selected,expanded,leaf,row,false);
