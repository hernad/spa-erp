...
/**
 * <p>Title: JraRadioButton</p>
 * <p>Description: Bindani JRadioButton.</p>
 * <p>Copyright: Copyright (c) 2002</p>
 * <p>Company: REST-ART</p>
 * <p>JRadioButton koji se binda na odgovarajuæu kolonu nekog DataSeta.
 * Podržava standardne tipke kao F10, Enter i Esc. Omoguæuje povezivanje
 * više istih buttona u kružnu listu po kojoj se može šetati kurzorskim
 * tipkama.</p>
 * @author ab.f
 * @version 1.0
 */

public class JraRadioButton extends JRadioButton implements raAbstractButton, ColumnAware {
  ...
  /**
	* Default konstruktor.
	*/
  public JraRadioButton() {
    initButton();
  }
  public JraRadioButton(Action action) {
    super(action);
    initButton();
  }
  public JraRadioButton(Icon icon) {
    super(icon);
    initButton();
  }
  public JraRadioButton(String text) {
    super(text);
    initButton();
  }
  public JraRadioButton(String text, Icon icon) {
    super(text,icon);
    initButton();
  }
