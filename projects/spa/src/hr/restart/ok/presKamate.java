...
public class presKamate extends PreSelect {
...
//    jlrCpar.forceFocLost();
  ...
  public void setOwner(frmKamateUpl owner) {
    this.frm = owner;
  }
  ...
  public boolean Validacija() {
    ...
    KamRac.getDataModule().setFilter("knjig = '"+getSelRow().getString("KNJIG")+
      (getSelRow().getInt("CPAR") == 0 ? "'" : "' AND cpar = "+getSelRow().getInt("CPAR")));
    dm.getKamRac().open();
    return true;
  }

  private void jbInit() throws Exception {
    this.setSelDataSet(dm.getKamUpl());

    jpDetail.setLayout(lay);
    lay.setWidth(570);
    lay.setHeight(75);

    if (getSelDataSet().hasColumn("DUGPOT") != null) {
