...
public class raOTPSectionHeader extends raReportSection {
  ...
  public raOTPSectionHeader(raReportTemplate owner) {
  ...
  private void modifyThis() {
    ...
    resizeElement(this.LabelSifra, Aut.getAut().getIzlazCARTwidth(), this.LabelNaziv_artikla);
  }
}
