...
public class raGRSectionFooter extends raReportSection {

  private String[] thisProps = new String[] {"BRDOK", "After", "", "", "Yes", "", "Yes", "3360"};
  ...
  private String[] Label1Props = new String[] {"", "", "9340", "100", "1480", "1360", "Normal",
  ...
  private String[] LabelUkupno_porezProps = new String[] {"Ukupno porez", "", "7100", "940", "2180",
     "240", "", "", "", "", "", "", "Lucida Bright", "9", "", "", "", "Right"};
  public raReportElement Text4;
  private String[] Text4Props = new String[] {
     "=(+ (+ (dsum \"POR1\") (dsum \"POR2\")) (dsum \"POR3\"))", "", "",
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9340", "940", "1480", "240", "", "",
     "", "", "", "", "Lucida Bright", "9", "", "", "", "Right", ""};
  ...
  private String[] Text5Props = new String[] {
     ...
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9340", "1220", "1480", "240", "", "",
  ...
  private String[] TextNAPOMENAOPISProps = new String[] {"NAPOMENAOPIS", "", "", "", "", "", "Yes",
     "Yes", "", "2300", "10520", "640", "", "", "", "", "", "", "Lucida Bright", "8", "", "", "",
     "", ""};

  public raGRSectionFooter(raReportTemplate owner) {
