...
public class raIzlazSKPDetail extends raReportSection {

  private String[] thisProps = new String[] {"", "", "", "", "", "No", "No", "520"};
  ...
  public raIzlazSKPDetail(raReportTemplate owner) {
