/****license*****************************************************************
**   file: raIzlazSectionFooterForCustomSlovima.java
...
public class raIzlazSectionFooterForCustomSlovima extends raReportSection {
  ...
  private String[] Label1Props = new String[] {"", "", "", "160", "10820", "240", "Normal", "Gray", 
     "", "", "", "", "Lucida Bright", "", "Bold", "", "", ""};
  ...
  private String[] Text1Props = new String[] {"=(dsum \"INABreal\")", "", "", 
  ...
  private String[] LabelSlovima_Props = new String[] {"Slovima :", "", "", "500", "840", "220", "", 
     "", "", "", "", "", "Lucida Bright", "8", "", "", "", ""};

  public raIzlazSectionFooterForCustomSlovima(raReportTemplate owner) {
