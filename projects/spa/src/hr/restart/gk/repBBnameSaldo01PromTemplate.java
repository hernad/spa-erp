/****license*****************************************************************
**   file: repBBnameSaldo01PromTemplate.java
...
public class repBBnameSaldo01PromTemplate extends repBBnameSaldoOrigTemplate {

  public repBBnameSaldo01PromTemplate() {
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepBBnameSaldo01Prom");
  ...
  public void modifyThis() {
    ...
    this.TextSALDO.setProperty(ep.CONTROL_SOURCE, "SALPROM");
  }
