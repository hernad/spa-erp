...
public class repBrutoBilanca implements raReportData {
  ...
  public repBrutoBilanca() {
    fbb = frmBrutoBilanca.getInstance();
...
//  }
  ...
  public String getZaPeriod() {
    return rdu.dataFormatter(fbb.newDatumP()) + " do " + rdu.dataFormatter(fbb.newDatumZ());
  }
  ...
  public String getNAZORG() {
      ...
      if (fbb.getSKUPNI().equals("ZBIRNO")) {
        ...
        nazorg = dm.getOrgstruktura().getString("NAZIV");
        return nazorg + " - ZBIRNO";
      } else {
        ru.setDataSet(ds);
        colname[0] = "CORG";
  ...
  public String getCORG() {
    if (fbb.getGroupMode().equals("1")) return fbb.getCORG();
