/****license*****************************************************************
**   file: repBBnameSaldo01PocStTemplate.java
...
public class repBBnameSaldo01PocStTemplate extends repBBnameSaldoOrigTemplate {

  public repBBnameSaldo01PocStTemplate() {
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepBBnameSaldo01PocSt");
  ...
  public void modifyThis() {
    ...
    this.TextSALDO.setProperty(ep.CONTROL_SOURCE, "SALPS");
  }
