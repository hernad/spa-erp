...
public class Banke extends KreirDrop implements DataModule {
  ...
  public void setall(){
    ...
    /*SqlDefTabela = "create table Banke " +
        ...
        "cbanka char(4) CHARACTER SET WIN1250 not null, "+    // �ifra
        "naziv  char(30) CHARACTER SET WIN1250, " +           // Naziv korisnika
        "ziro char(40) CHARACTER SET WIN1250, " +             // �iro ra\u010Dun banke
  ...
  private void jbInit() throws Exception {
    ...
    bankeZIRO.setCaption("�iro ra\u010Dun");
