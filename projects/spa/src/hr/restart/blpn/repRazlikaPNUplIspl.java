...
public class repRazlikaPNUplIspl implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  hr.restart.robno._Main main;
  frmRazlikaPN fui = frmRazlikaPN.getFRPN();
  DataSet ds = frmRazlikaPN.getFRPN().getRepQDS();
  ...
  public repRazlikaPNUplIspl() {
    ru.setDataSet(ds);
  }

  public repRazlikaPNUplIspl(int idx) {
    if(idx==0){
      rb = 0;
    }
    ds.goToRow(idx);
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repRazlikaPNUplIspl(indx++);
      }
