...
public class presRazlikaPN extends presAkontacijaPN {

  hr.restart.swing.JraTextField jraCblag = new hr.restart.swing.JraTextField();
  ...
  public void SetFokus(){
    ...
    jlrCradnik.getRaDataSet().open();//zbog db synchronizera
