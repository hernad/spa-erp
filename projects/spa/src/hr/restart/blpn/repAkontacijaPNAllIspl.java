/****license*****************************************************************
**   file: repAkontacijaPNAllIspl.java
...
public class repAkontacijaPNAllIspl implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  hr.restart.robno._Main main;
  frmAkontacijaPN fui = frmAkontacijaPN.getFAPN();
  DataSet ds = frmAkontacijaPN.getFAPN().getRepQDSall();
  ...
  public repAkontacijaPNAllIspl() {
    ru.setDataSet(ds);
  }

  public repAkontacijaPNAllIspl(int idx) {
    if(idx==0){
      rb = 0;
    }
    ds.goToRow(idx);
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repAkontacijaPNAllIspl(indx++);
      }
