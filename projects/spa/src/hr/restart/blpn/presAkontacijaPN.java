...
public class presAkontacijaPN extends PreSelect {
  ...
  private void jbInit() throws Exception {
    ...
    jpDetail.add(jlaCradnik,    new XYConstraints(151, 23, 68, -1));
    jpDetail.add(jlrCradnik,       new XYConstraints(150, 40, 70, -1));
    jpDetail.add(jlaIme,   new XYConstraints(226, 23, 148, -1));
    jpDetail.add(jlrIme,   new XYConstraints(225, 40, 150, -1));
    ...
    jpDetail.add(jlrCpn,     new XYConstraints(150, 65, 225, -1));
  ...
  protected void setCradnik() {
    jlrCradnik.setRaDataSet(ss.getPutniNaloziPrAk('A'));
