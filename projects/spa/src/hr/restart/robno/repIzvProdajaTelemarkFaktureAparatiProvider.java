/****license*****************************************************************
**   file: repIzvProdajaTelemarkFaktureAparatiProvider.java
...
public class repIzvProdajaTelemarkFaktureAparatiProvider implements raReportData {
  ...
  frmIzvProdajaTelemarkFaktureAparati main = frmIzvProdajaTelemarkFaktureAparati.getInstance();
  ...
  public repIzvProdajaTelemarkFaktureAparatiProvider() {
    ds = main.getReportSet();
    ru.setDataSet(ds);
    agenti = main.getTelad();
...
//   return vrati; 
  ...
  public String getCAGENT(){
    return ds.getString("CTEL");
  }
  
  public String getNAZAGENT(){
    return agenti.get(ds.getString("CTEL")+"").toString();
  }
  ...
  private void makeRekapAparatStrings(){
    ...
    for (Iterator iter = rekapAparatz.keySet().iterator(); iter.hasNext();) {
      ...
      System.out.println("NAZIVI\n"+unszk); //XDEBUG delete when no more needed
      System.out.println("kolicine\n"+unszv); //XDEBUG delete when no more needed
    }
