...
public class repPocetnoStanje implements sg.com.elixir.reportwriter.datasource.IDataProvider {
  ...
  public repPocetnoStanje() {
  }

  public repPocetnoStanje(int idx) {
    ds.goToRow(idx);
  }
...
//        syst.prn(ds);
      ...
      public Object nextElement() {
        ...
        return new repPocetnoStanje(indx++);
      }
