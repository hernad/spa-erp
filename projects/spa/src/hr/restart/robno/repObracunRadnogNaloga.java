/****license*****************************************************************
**   file: repObracunRadnogNaloga.java
...
public class repObracunRadnogNaloga implements raReportData {//sg.com.elixir.reportwriter.datasource.IDataProvider {
...
//  hr.restart.util.sysoutTEST sys = new hr.restart.util.sysoutTEST(false);
  ...
  public repObracunRadnogNaloga() {
    ru.setDataSet(detalji);
  }
/*
  public repObracunRadnogNaloga(int idx) {
    detalji.goToRow(idx);
    prijava.goToRow(0);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      {
        detalji = rnl.getrepQDSdetails();
        prijava.open();
        detalji.open();
      }
      int indx=0;
      public Object nextElement() {
        return new repObracunRadnogNaloga(indx++);
      }
...
*/
  ...
  */
  ...
  public String getVLASNIKIME() {
    return rnl.getVlasnikIme(prijava);
  }
