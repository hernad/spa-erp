/****license*****************************************************************
**   file: repPregledManjakExtendedVersionTemplate.java
...
public class repPregledManjakExtendedVersionTemplate extends repOMVTemplate {

  public repPregledManjakExtendedVersionTemplate() {
    System.out.println("F**KIN CLASS!! No01 - repPregledManjakExtendedVersionTemplate");
    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepPregledManjakExtendedVersion");
