/****license*****************************************************************
**   file: repOTPsifKupKutVriTemplate.java
...
import hr.restart.util.reports.raIzlazOTPsifKupDetailVri;
import hr.restart.util.reports.raIzlazOTPsifKupVriSectionHeader1;
...
public class repOTPsifKupKutVriTemplate extends repOTPvriOrigTemplate {
  ...
  /*public repOTPsifKupVriTemplate() {
...
//        modifyThis();
  ...
  public void modifyThis() {
    ...
    this.SectionHeader1.resizeElement(this.LabelSifra, Aut.getAut().getIzlazCARTdep(900, 1780, 1780), this.LabelNaziv_artikla);
    this.Detail.resizeElement(this.TextCART, Aut.getAut().getIzlazCARTdep(900, 1780, 1780), this.TextNAZART);
  }*/

  public raReportSection createDetail() {
    raIzlazOTPsifKupDetailVri det = new raIzlazOTPsifKupDetailVri(this);
    
    det.TextJM.setDefault(ep.CONTROL_SOURCE,"JMPAK");
    det.TextKOL.setDefault(ep.CONTROL_SOURCE, "KOLPAK");
    
    return det;
  }
  
  public raReportSection createSectionHeader1() {
    return new raIzlazOTPsifKupVriSectionHeader1(this);
  }
