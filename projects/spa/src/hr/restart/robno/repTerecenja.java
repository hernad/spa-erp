...
public class repTerecenja implements sg.com.elixir.reportwriter.datasource.IDataProvider {
...
/*
  ...
  public String getNAZORG() {
    colname[0] = "CSKL";
    colname2[0] = "CORG";
    String something = ru.getSomething2(colname2,colname,ds,dm.getOrgstruktura(),"NAZIV").getString();
    return something;
  }
  ...
  public String getNAZVRTR(){
    colname[0] = "CVRTR";
    return ru.getSomething(colname,dm.getVrtros(),"NAZIV").getString();
  }
 ...
 public String getCART() {
    ...
    else if (hr.restart.sisfun.frmParam.getParam("robno","indiCart").equals("CART1"))
      return ds.getString("CART1");
    else if (hr.restart.sisfun.frmParam.getParam("robno","indiCart").equals("BC"))
      return ds.getString("BC");
    return "";
  }
  ...
  public double getIRAZ() {
    suma = suma + ds.getBigDecimal("IRAZ").doubleValue();
    return ds.getBigDecimal("IRAZ").doubleValue();
  }

  public String getIRAZ_SLOVIMA() {
  // privremeno !!!!
