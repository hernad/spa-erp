...
public class repPRECorgkol implements sg.com.elixir.reportwriter.datasource.IDataProvider {
  ...
  public repPRECorgkol() {
    suma=_Main.nul;
  }

  public repPRECorgkol(int idx) {
    if (idx == 0){
      suma=_Main.nul;
    }
    ds.goToRow(idx);
  ...
  public String getORGLABEL(){
    if (!ds.getString("CORG").equals("")) {
      return "Organizacijska jedinica";
    }
    return "";
  }
