...
public class repRacuniSKL implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  static JraTextField por = new JraTextField();
  _Main main;
  DataSet ds = reportsQuerysCollector.getRQCModule().getQueryDataSet(); // getvalutequery....
