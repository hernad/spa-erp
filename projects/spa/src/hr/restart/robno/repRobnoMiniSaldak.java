...
public class repRobnoMiniSaldak implements raReportData {
  DataSet ds;
  ...
  public repRobnoMiniSaldak() {
//    pokazSal = 0.0;
    //ds = rms.getQDS();
    ds = rms.getJPTV().getSelectionView();
//    hr.restart.util.sysoutTEST syst = new hr.restart.util.sysoutTEST(false);
//    syst.prn(ds);
    izracunajPokazniSaldo();
    ru.setDataSet(ds);
  }
...
//    pokazSal = pokazSal+ ds.getBigDecimal("SALDO").doubleValue();
  ...
  public String getSuglasniSaldo(){
    return "OD " + hr.restart.robno.sgQuerys.getSgQuerys().format(pokazSal,2) + " Kn U KORIST " + rm.getFirstLine(); 
  }
