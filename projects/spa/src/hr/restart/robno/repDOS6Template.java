...
import hr.restart.util.reports.raDosDetailJmc;
import hr.restart.util.reports.raDosSH1jmc;
import hr.restart.util.reports.raReportSection;

public class repDOS6Template extends repDOSTemplate {

  public raReportSection createSectionHeader1() {
    return new raDosSH1jmc(this);
/*    rsh.LabelSifra.setCaption(Aut.getAut().getIzlazCARTdep("Šifra", "Oznaka", "Barcode"));
  ...
  public raReportSection createDetail() {
    return new raDosDetailJmc(this);
