...
public class repPRVTemplate extends repIzlazOrigTemplate  {
...
//    raRPSectionHeader sh = new raRPSectionHeader(this);
    ...
    sh.defaultAltererSect().getView(sh.LabelMjestoDatum, sh.TextNAZFRA).
        deleteElementsPushDown(sh, new raReportElement[] {sh.LabelDospijeceDatum, sh.LabelDatum_isporuke,
        sh.LabelNacin_otpreme, sh.LabelNacin_placanja, sh.LabelNarudzba,
        sh.LabelParitet, sh.TextSgetDVO, sh.TextSgetDATDOSP, sh.TextSgetDDOSP, sh.TextBRNARIZ,
