...
public class repRekapTros implements sg.com.elixir.reportwriter.datasource.IDataProvider {
...
//  DataSet ds = upPregledTroskova.getupPregletTroskova().getReportQDS();
  ...
  public double getUKUPNOGODINA(){
     return ds.getBigDecimal("GODINA").doubleValue();
  }

  public String getPodnaslov(){
    return "za ".concat(urt.getGodinu().concat(". godinu"));
  }
