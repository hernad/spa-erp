/****license*****************************************************************
**   file: repRacZaRnalOrigTemplate.java
...
public abstract class repRacZaRnalOrigTemplate extends raReportTemplate {
  ...
  private String[] Label1Props = new String[] {"", "", "9420", "80", "1400", "240", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement Label2;
  private String[] Label2Props = new String[] {"", "", "", "80", "8180", "220", "Normal", "Gray", 
     "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement Label3;
  private String[] Label3Props = new String[] {"%", "", "8200", "80", "1200", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement TextRADOVIMATERIJAL;
  private String[] TextRADOVIMATERIJALProps = new String[] {"RADOVIMATERIJAL", "", "", "", "", "", 
     "", "", "", "80", "3160", "220", "", "-1973791", "", "", "", "", "Lucida Bright", "8", "Bold", 
     "", "", "", ""};
  public raReportElement Text4;
  private String[] Text4Props = new String[] {"=(put-var \"H1\" 1)", "", "", "", "No", "", "", "", 
     "3540", "100", "2640", "140", "", "", "", "", "", "", "", "", "", "", "", "", ""};
  public raReportElement LabelIznos;
  private String[] LabelIznosProps = new String[] {"Iznos", "", "9420", "200", "1400", "340", 
     "Normal", "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement Label4;
  private String[] Label4Props = new String[] {"", "", "5540", "320", "920", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelNaziv;
  private String[] LabelNazivProps = new String[] {"Naziv", "", "1920", "320", "3600", "220", 
     "Normal", "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelPor;
  private String[] LabelPorProps = new String[] {"Por", "", "8840", "320", "560", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelSifra;
  private String[] LabelSifraProps = new String[] {"Šifra", "", "480", "320", "1420", "220", 
     "Normal", "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelRbr;
  private String[] LabelRbrProps = new String[] {"Rbr", "", "", "320", "460", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelCijena;
  private String[] LabelCijenaProps = new String[] {"Cijena", "", "6960", "320", "1220", "220", 
     "Normal", "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelJmj;
  private String[] LabelJmjProps = new String[] {"Jmj", "", "6480", "320", "460", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement LabelPop;
  private String[] LabelPopProps = new String[] {"Pop", "", "8200", "320", "620", "220", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  public raReportElement TextKOLICINEJEDINICE;
  private String[] TextKOLICINEJEDINICEProps = new String[] {"KOLICINEJEDINICE", "", "", "", "", "", 
     "", "", "5540", "320", "920", "220", "", "", "", "", "", "", "Lucida Bright", "8", "Bold", "", 
     "", "Center", "No"};
  public raReportElement Line2;
  private String[] Line2Props = new String[] {"", "", "", "560", "10800", "0", "", "", ""};
  ...
  private String[] TextKOLProps = new String[] {"KOL", "", "", 
     "Number|false|1|309|3|3|true|3|false", "", "", "", "", "5540", "", "920", "220", "", "", "", 
     "", "", "", "Lucida Bright", "8", "", "", "", "Right", "No"};
  ...
  private String[] TextNAZARTProps = new String[] {"NAZART", "", "", "", "", "", "Yes", "", "1920", 
     "", "3600", "220", "", "", "", "", "", "", "Lucida Bright", "8", "", "", "", "", ""};
  public raReportElement TextCART;
  private String[] TextCARTProps = new String[] {"CART", "", "", "", "", "", "", "", "480", "", 
     "1420", "220", "", "", "", "", "", "", "Lucida Bright", "8", "", "", "", "Right", "No"};
  ...
  private String[] Line4Props = new String[] {"", "", "", "40", "10800", "0", "", "", ""};
  public raReportElement Text11;
  private String[] Text11Props = new String[] {"=(dsum \"INETO\")", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9120", "100", "1700", "240", "", "", 
     "", "", "", "", "Lucida Bright", "9", "", "", "", "Right", ""};
  public raReportElement LabelUkupno;
  private String[] LabelUkupnoProps = new String[] {"Ukupno", "", "6860", "100", "2180", "240", "", 
     "", "", "", "", "", "Lucida Bright", "9", "", "", "", "Right"};
  public raReportElement Label5;
  private String[] Label5Props = new String[] {"", "", "9040", "100", "1780", "1360", "Normal", 
     "Gray", "Solid", "Gray", "", "", "Lucida Bright", "8", "Bold", "", "", "Center"};
  ...
  private String[] LabelREKAPITULACIJA_POREZAProps = new String[] {"REKAPITULACIJA POREZA", "", 
     "440", "340", "5020", "240", "", "", "", "", "", "", "Lucida Bright", "9", "", "", "", 
     "Center"};
  public raReportElement Text12;
  private String[] Text12Props = new String[] {"=(dsum \"UIRAB\")", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9120", "380", "1700", "240", "", "", 
     "", "", "", "", "Lucida Bright", "9", "", "", "", "Right", ""};
  public raReportElement LabelPopust;
  private String[] LabelPopustProps = new String[] {"Popust", "", "6860", "380", "2180", "240", "", 
     "", "", "", "", "", "Lucida Bright", "9", "", "", "", "Right"};
  public raReportElement LabelGrupa;
  private String[] LabelGrupaProps = new String[] {"Grupa", "", "460", "620", "1200", "240", "", "", 
     "", "", "", "", "Lucida Bright", "8", "", "", "", ""};
  public raReportElement LabelPorez;
  private String[] LabelPorezProps = new String[] {"Porez", "", "4600", "620", "1300", "240", "", 
     "", "", "", "", "", "Lucida Bright", "8", "", "", "", "Right"};
  public raReportElement LabelOsnovica;
  private String[] LabelOsnovicaProps = new String[] {"Osnovica", "", "3000", "620", "1300", "240", 
     "", "", "", "", "", "", "Lucida Bright", "8", "", "", "", "Right"};
  public raReportElement Label6;
  private String[] Label6Props = new String[] {"%", "", "2140", "620", "720", "240", "", "", "", "", 
     "", "", "Lucida Bright", "8", "", "", "", "Center"};
  public raReportElement Text13;
  private String[] Text13Props = new String[] {"=(dsum \"IPRODBP\")", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9120", "660", "1700", "240", "", "", 
     "", "", "", "", "Lucida Bright", "9", "", "", "", "Right", ""};
  ...
  private String[] LabelUkupno_bez_porezaProps = new String[] {"Ukupno bez poreza", "", "6860", 
     "660", "2180", "240", "", "", "", "", "", "", "Lucida Bright", "9", "", "", "", "Right"};
  ...
  private String[] TextPorezDepartmentUKUPORProps = new String[] {"PorezDepartmentUKUPOR", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "Yes", "", "2120", "860", "720", "220", "", "", 
     "", "", "", "", "Lucida Bright", "8", "", "", "", "Right", ""};
  ...
  private String[] TextPorezDepartmentIPRODBPProps = new String[] {"PorezDepartmentIPRODBP", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "Yes", "", "3000", "860", "1300", "220", "", 
     "Light Gray", "", "", "", "", "Lucida Bright", "8", "", "", "", "Right", ""};
  public raReportElement Text14;
  private String[] Text14Props = new String[] {
     "=(+ (+ (dsum \"POR1\") (dsum \"POR2\")) (dsum \"POR3\"))", "", "", 
     "Number|false|1|309|2|2|true|3|false", "", "", "", "", "9120", "940", "1700", "240", "", "", 
     "", "", "", "", "Lucida Bright", "9", "", "", "", "Right", ""};
  public raReportElement LabelUkupno_porez;
  private String[] LabelUkupno_porezProps = new String[] {"Ukupno porez", "", "6860", "940", "2180", 
  ...
  public repRacZaRnalOrigTemplate() {
