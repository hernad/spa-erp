...
public class raWebSync {
  ...
  static void loadParams() {
    try {
      ...
      String skl = frmParam.getParam("sisfun", "webSklads", "", "Skladi�ta za web sync");
      ...
      if (pb != null) {
        ...
        if (nars+gots > 0) {
          ...
          for (int i = 0; i < us.length; i++) {
            ...
            MsgDispatcher.send("sistem", us[i], "Dohva�eno " + nars + " narud�bi i " +gots+" racuna s webshop servera.");
          }
        }
      }
