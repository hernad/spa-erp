/****license*****************************************************************
**   file: repOtpisRobeExtendedVersion.java
...
public class repOtpisRobeExtendedVersion implements sg.com.elixir.reportwriter.datasource.IDataProvider {
  ...
  public repOtpisRobeExtendedVersion() {
  }

  public repOtpisRobeExtendedVersion(int idx) {
//    if (idx == 0){
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repOtpisRobeExtendedVersion(indx++);
      }
