...
public class frmIzvHCCPu extends raUpitLite {
  ...
  static frmIzvHCCPu fD;
  
  public static frmIzvHCCPu getInstance() {
    return fD;
  }
  ...
  public void okPress() {
    ...
    String q = 
     "SELECT doki.cpar, doki.pj, doki.datdok, doki.brdok, stdoki.nazart, stdoki.kol,"+
      "stdoki.lot, doki.cradnal as creg, stdoki.rbr, partneri.nazpar, pjpar.nazpj"+
      " FROM doki INNER JOIN stdoki ON "+rut.getDoc("doki", "stdoki")+ " INNER JOIN partneri"+
      " ON doki.cpar=partneri.cpar LEFT OUTER JOIN pjpar ON doki.cpar=pjpar.cpar and doki.pj=pjpar.pj WHERE doki.vrdok='DOS' AND "+
      jrfCSKL.getCondition().and(Condition.between("DATDOK", 
          tds, "DATFROM", "DATTO")).qualified("doki");
  ...
  private void jbInit() throws Exception {
    ...
    this.addJasper("hr.restart.robno.repHCCPizlaz","hr.restart.robno.repHCCPizlaz","hccpiz.jrxml","Ispis evidencije");
  }
}
