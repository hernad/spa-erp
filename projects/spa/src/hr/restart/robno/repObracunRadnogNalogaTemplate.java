/****license*****************************************************************
**   file: repObracunRadnogNalogaTemplate.java
...
public class repObracunRadnogNalogaTemplate extends repRadniNalogOrig2Template{

  public repObracunRadnogNalogaTemplate(){
  }
  ...
  public raReportSection createSectionFooter3(){
    return new raReportSection(template.getModel(ep.SECTION_FOOTER+3), new String[]{"JEDANBROJ", "", "", "", "Yes", "", "Yes", "0"});
  }
