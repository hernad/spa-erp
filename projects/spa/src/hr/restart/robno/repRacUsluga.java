...
/**
 * Generated by hr.restart.util.JDOPrintCreator
 */
...
public class repRacUsluga implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  _Main main;
  DataSet ds = raAutomatRac.getraAutomatRac().getQuery();
  ...
  public String getTEL(){
    colname[0] = "CPAR";
    return "Tel "+ru.getSomething(colname,dm.getPartneri(),"TEL").getString();
  }

  public String getFAX(){
    colname[0] = "CPAR";
    return "Fax "+ru.getSomething(colname,dm.getPartneri(),"TELFAX").getString();
  }
  ...
  public String SgetDATUG() {
    if (!ds.getString("CUG").equals(""))
      return rdu.dataFormatter(getDATUG());
    return "";
  }
  public String getUGOVORLABEL(){
    if (!ds.getString("CUG").equals(""))
      return "Ugovor";
    return "";
  }
...
//    String nazOpis = getNAZNAP() + "\n" + getOPIS();
    String nazOpis = getNAZNAP().concat("\n".concat(getOPIS()));
    return nazOpis;
  }
...
//   return ds.getString("NAZART");
  ...
  public String getSLOVIMA() {
   return ut.numToLet(ds.getBigDecimal("IPRODSP").doubleValue());
  }
  ...
  public String getLogoTels(){return rm.getLogoTel1().concat(", ".concat(rm.getLogoTel2()));}
}