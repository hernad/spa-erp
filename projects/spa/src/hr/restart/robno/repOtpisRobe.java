...
public class repOtpisRobe implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  _Main main;
  DataSet ds = frmOtpisRobe.getInstance().getrepQDS();
...
//    lookupData.getlookupData().raLocate(dm.getArtikli(), new String[] {"cart"}, new String[] {ds.getString("CART")});
...
//    return ds.getBigDecimal("ZC").multiply(ds.getBigDecimal("KOL"));
//  }
