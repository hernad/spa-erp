...
public class raVtzavtr extends JraDialog {
//extends raSifraNaziv {
  ...
  raFilteriRazni.fVtzavtr filter;
...
//      dm.getvshrab_rab().removeRowFilterListener(filter);
  ...
  public void setCriteria(String skladiste,String vrstadokumenta,String godina,int brojdok,short rbroj){
      ...
      try {
        dm.getVtzavtr().removeRowFilterListener(filter);
        dm.getVtzavtr().addRowFilterListener(filter);
      } catch (Exception e) {}

      dm.getVtzavtr().refilter();
  }
  public void show() {
