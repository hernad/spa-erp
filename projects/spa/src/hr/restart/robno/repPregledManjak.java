...
public class repPregledManjak implements sg.com.elixir.reportwriter.datasource.IDataProvider {
  ...
  public repPregledManjak() {
  }

  public repPregledManjak(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
      ...
      public Object nextElement() {
        ...
        return new repPregledManjak(indx++);
      }
