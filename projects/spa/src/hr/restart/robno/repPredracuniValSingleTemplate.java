/****license*****************************************************************
**   file: repPredracuniValSingleTemplate.java
...
import hr.restart.util.reports.raDetailValSingle;
import hr.restart.util.reports.raIzlazSectionFooterValSingle;
import hr.restart.util.reports.raIzlazSectionHeaderValSingle;
...
public class repPredracuniValSingleTemplate extends repIzlazOrigTemplate {
...
//  zakaii::     sh.TextTEL.defaultAlterer().setVisible(false);
  ...
  public raReportSection createSectionHeader1() {
    return new raIzlazSectionHeaderValSingle(this); // return new raIzlazSectionHeader(this);
  }

  public raReportSection createDetail() {
    return new raDetailValSingle(this);
  }

  public raReportSection createSectionFooter1() {
    return new raIzlazSectionFooterValSingle(this); // return new raIzlazSectionFooter(this);
  }

  public repPredracuniValSingleTemplate() {
