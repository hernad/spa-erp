...
public class repSklStanje implements raReportData { // sg.com.elixir.reportwriter.datasource.IDataProvider
                                                  // {

  _Main main;

  repMemo rpm = repMemo.getrepMemo();
  upStanjeNaSkladistu ups = upStanjeNaSkladistu.getInstance();
  DataSet ds;
