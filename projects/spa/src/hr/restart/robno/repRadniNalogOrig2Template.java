/****license*****************************************************************
**   file: repRadniNalogOrig2Template.java
...
public abstract class repRadniNalogOrig2Template extends raReportTemplate {
  ...
  private String[] Section0Props = new String[] {"BRDOKRNL", "", "Yes", "Yes", "Each Value", "", ""};
  ...
  private String[] Section3Props = new String[] {"JEDANBROJ", "", "Yes", "Yes", "Each Value", "", ""};
...
//  private String[] Section4Props = new String[] {"NAZART", "", "", "", "", "", ""};
  ...
  public repRadniNalogOrig2Template() {
...
//    Section4 = sect.getModel(ep.SECTION + 4, Section4Props);
  ...
  public abstract raReportSection createSectionFooter3();
