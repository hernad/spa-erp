...
public class repPorList implements raReportData {
...
//  public java.sql.Timestamp getDATUMDOK(){
//    return hr.restart.util.Util.getUtil().getFirstSecondOfDay(
...
//    return ds.getBigDecimal("ISP");
  ...
  public BigDecimal getRAZLIKAVRATITI(){
    return sum.getBigDecimal("RAZPOV");
  }

  public BigDecimal getRAZLIKAPLATIT(){
    return sum.getBigDecimal("RAZPLA");
  }
