/****license*****************************************************************
**   file: repPregledVisakTemplate.java
...
public class repPregledVisakTemplate extends repOMVsmallTemplate {

  public repPregledVisakTemplate() {
    System.out.println("F**KIN CLASS!! No01 - repPregledVisakTemplate");
//    this.ReportTemplate.setDefault(ep.RECORD_SOURCE, "JDOrepPregledVisak");
//    this.LabelOTPIS_ROBE.setDefault(ep.CAPTION, "\nINVENTURNI VIŠAK");
    this.LabelOTPIS_ROBE.defaultAlterer().setCaption("\nINVENTURNI VIŠAK");
...
//    hr.restart.util.Aus.dumpModel(this.getUnmodifiedReportTemplate(), 0);
