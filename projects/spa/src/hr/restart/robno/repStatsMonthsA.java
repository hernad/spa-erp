...
public class repStatsMonthsA implements raReportData {
  DataSet ds;
...
//    syst.prn(ds);
  ...
  public String getCARTNASLOV(){
    return Aut.getAut().getIzlazCARTdep("Šifra artikla","Oznaka artikla","Barcode");
  }
...
//        }
  ...
  public String getNAZSKL() {
    if (getCSKL().trim().length() == 0) return "Za sva skladišta";
