...
public class RaCarZemlje extends raSifraNaziv {
		...
		private void jbInit() throws Exception {
			...
			oznaka.setColumnName("COZNDRV");
			oznaka.setDataSet(dm.getCardrzava());
			this.setRaDataSet(dm.getCardrzava());
			this.setRaColumnSifra("CSIFDRV");
			this.setRaColumnNaziv("NAZIV");
			this.setRaText("Država");
			defaultAdd2Panel2();
		}
