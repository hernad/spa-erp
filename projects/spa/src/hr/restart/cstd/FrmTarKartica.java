...
public class FrmTarKartica extends raUpitFat {
...
//        jp.setPreferredSize(new Dimension(555, 45));
        ...
        jp.add(princ,     new XYConstraints(15, 30, -1, -1));
        jp.add(jrtfCPAR, new XYConstraints(150, 30, 100, -1));
        jp.add(jrtfNAZIVPAR, new XYConstraints(254, 30, 327, -1));
        jp.add(jrtfCPARB, new XYConstraints(584, 30, 21, 21));
