...
public class repIspVirNew2 extends repMatrixVirmans {

  public repIspVirNew2() {
    init();
  }
  ...
  public String[] getDetail(){
    String[] detail = new String[] {
      "<$CondensedOFF$>"+
      "<#DUMMY|25|left#><#ROW1|33|left#>"+
      "<$newline$><$newline$>"+
      "<#DUMMY|34|left#><#ROW9|47|right#>"+
      "<$newline$><$newline$>"+
      "<#DUMMY|4|left#><#ROW2|140|left#>"+
      "<$newline$>"+
      "<$CondensedOFF$><#DUMMY|4|left#><$CondensedON$><#ROW3|100|left#>"+
      "<$CondensedOFF$><$newline$>"+
      "<#DUMMY|4|left#><#ROW4|145|left#>"+
      "<$newline$><$newline$>"+
      "<$CondensedOFF$><#DUMMY|4|left#><#ROW5|140|left#>"+
      "<$newline$>"+
      "<$CondensedOFF$><#DUMMY|4|left#><$CondensedON$><#ROW6|100|left#>"+
      "<$newline$><$CondensedOFF$>"+
      "<#DUMMY|4|left#><#ROW7|145|left#>"+
      "<$newline$><$newline$>"+
      "<$CondensedOFF$><#DUMMY|13|left#><#ROW8|88|left#><$CondensedOFF$>"+
      "<$newline$><$newline$>"+
  ...
  public void fill() {
    ...
    while(qds.inBounds()) {
      ...
      checkLL();
      virmanDS.setString("ROW2", handleGlobal(svrha.get(0).toString()," "+qds.getString("PNBZ1"),qds.getString("BRRACNT"),justName(qds.getString("NATERET").trim())));
