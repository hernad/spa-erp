...
public class frmPartneri extends raMatPodaci {
  ...
  raNavAction rnvZiro = new raNavAction("�iro ra\u010Duni",raImages.IMGALIGNJUSTIFY,KeyEvent.VK_F8) {
    public void actionPerformed(ActionEvent e) {
  ...
  raNavAction rnvSifArt = new raNavAction("�ifre Artikala",raImages.IMGOPEN,KeyEvent.VK_F12){
    public void actionPerformed(ActionEvent e) {
...
/*      if (mode == 'B' || mode == 'I') {
  ...
  private void showPromet() {
    ...
    if (getRaQueryDataSet().getString("ULOGA").equalsIgnoreCase("D")) {
      JOptionPane.showMessageDialog(this.getWindow(), "Partner je dobavlja�!",
  ...
  public boolean Validacija(char mode) {
    ...
    boolean forceUniqueMb = frmParam.getParam("zapod", "mbUnique", "D", 
      "Forsirati jedinstvenost mati�nog broja partnera (D,N)?").equalsIgnoreCase("D");
    boolean forceUniqueZr = frmParam.getParam("zapod", "zrUnique", "D", 
      "Forsirati jedinstvenost �iro ra�una partnera (D,N)?").equalsIgnoreCase("D");
    if (mode=='N') {
...
//    super.AfterDelete();
  ...
  void rnvZiro_actionPerformed(ActionEvent e) {
    ...
    hr.restart.util.startFrame.getStartFrame().centerFrame(fZP,0,"�iro ra�uni partnera "+getRaQueryDataSet().getInt("CPAR"));
    fZP.show();
  }
  ...
  void rnvSifArt_actionPerformed(ActionEvent e) {
    ...
    hr.restart.util.startFrame.getStartFrame().centerFrame(fPa,0,"�ifre artikala partnera " + getRaQueryDataSet().getString("NAZPAR"));
    fPa.show();
  }
