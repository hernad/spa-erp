...
//  }
  ...
  public String getVIRMANINFO() {
    return 
        "DRéAVNI PRORA»UN REPUBLIKE HRVATSKE    RA»UN: 1001005-1863000160 \n" +
        "DOPRINOS MIO I.STUP                    PNB:   (68) 8109-"+rpm.getLogoOIB()+"\n"+
        "\n"+
        "DRéAVNI PRORA»UN REPUBLIKE HRVATSKE    RA»UN: 1001005-1700036001 \n" +
        "DOPRINOS MIO II.STUP                   PNB:   (68) 2003-"+rpm.getLogoOIB()+"\n"+
        "\n"+
        "POREZ I PRIREZ NA DOHODAK              RA»UN: "+raVirPlMnWorker.getZiroOpc(_getCOpcine())+" \n" +
