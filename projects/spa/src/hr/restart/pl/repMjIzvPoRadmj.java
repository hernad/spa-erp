...
public class repMjIzvPoRadmj implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  frmMjIzv frmi = frmMjIzv.getFrmMjIzv();
  DataSet ds = frmi.getRepPoCradMj(); /** @todo paz vamo */
...
//    System.out.println("MjIzv - RIPORT");
  ...
  public repMjIzvPoRadmj(int idx) {
    if (idx == 0){}
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    ...
    public Object nextElement() {
      ...
      return new repMjIzvPoRadmj(indx++);
    }
