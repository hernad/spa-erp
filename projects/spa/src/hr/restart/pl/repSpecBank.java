...
public class repSpecBank implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  DataSet ds = frmBankSpec.getInstance().getSpecBankDS(new String[] {"CISPLMJ","PREZIME","IME"});
...
//******************** M O J I  P O D A C I ******************************
  ...
  public int getCBanke()
  {
    return ds.getInt("CBANKE");
  }

  public String getNazBanke()
  {
    String cbanke= getCBanke()+"";
    ld.raLocate(dm.getBankepl(), new String[]{"CBANKE"}, new String[]{cbanke});
    return dm.getBankepl().getString("NAZBANKE");
  }
