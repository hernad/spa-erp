/****license*****************************************************************
**   file: repPopListIM_IznNull.java
...
public class repPopListIM_IznNull implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  ...
  public repPopListIM_IznNull() {
     ru.setDataSet(ds);
  }

  public repPopListIM_IznNull(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    ...
    public Object nextElement() {
      return new repPopListIM_IznNull(indx++);
    }
