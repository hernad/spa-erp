...
public class repRekObrVRO implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  DataSet ds = frmRekObr.getQdsVRO();

  QueryDataSet doprinosiNa = frmRekObr.getDoprinosiNaVRO();
  QueryDataSet doprinosiR = frmRekObr.getDoprinosiIzVRO();
...
//******************** M O J I  P O D A C I ******************************
  ...
  public String getObracunLab()
 {
  ...
  {
    String nazVro ="";
    String cVro = frmRekObr.getFrmRekObr().fieldSet.getString("CVRO");
    ru.setDataSet(ds);
    colname[0] = "CVRO";
  ...
  public int getBrRad()
  {
    return frmRekObr.getFrmRekObr().getbrDjelatnikaVRO(ds.getString("CVRO"),"");
  }
  ...
  public String getDoprinosiNaOpis()
{
  ...
  {
    if(doprinosiNa.getString("CVRO").equals(this.getCVro()))
    {
  ...
  public String getDoprinosiIzOpis()
{
 ...
 {
   if(doprinosiR.getString("CVRO").equals(this.getCVro()))
   {
