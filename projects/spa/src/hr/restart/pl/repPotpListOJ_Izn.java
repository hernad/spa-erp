...
public class repPotpListOJ_Izn implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  ...
  public repPotpListOJ_Izn() {
     ru.setDataSet(ds);
  }

  public repPotpListOJ_Izn(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    ...
    public Object nextElement() {
      return new repPotpListOJ_Izn(indx++);
    }
