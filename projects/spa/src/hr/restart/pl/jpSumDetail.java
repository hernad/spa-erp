...
public class jpSumDetail extends JPanel {
  ...
  private void jbInit() throws Exception {
    ...
    jlrCvrp.setDataSet(fSume.getDetailSet());
    ...
    jcbAktiv.setDataSet(fSume.getDetailSet());
