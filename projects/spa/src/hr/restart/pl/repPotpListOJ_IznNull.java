/****license*****************************************************************
**   file: repPotpListOJ_IznNull.java
...
public class repPotpListOJ_IznNull implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  DataSet ds = frmBankSpec.getInstance().getSpecBankDS(new String[] {"CORG","CISPLMJ","PREZIME","IME"});
  ...
  public repPotpListOJ_IznNull() {
     ru.setDataSet(ds);
  }

  public repPotpListOJ_IznNull(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    ...
    public Object nextElement() {
      return new repPotpListOJ_IznNull(indx++);
    }
...
//******************** M O J I  P O D A C I ******************************
  ...
  public int getRowNum()
 {
  ...
  {
    String cOJ = getOJ();
    ld.raLocate(dm.getOrgstruktura(), new String[]{"CORG"}, new String[]{cOJ});
