...
public class repRekObrZN implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  DataSet ds = frmRekObr.getQdsZN();

  QueryDataSet doprinosiNa = frmRekObr.getDoprinosiNaZN();
  QueryDataSet doprinosiR = frmRekObr.getDoprinosiIzZN();
...
//******************** M O J I  P O D A C I ******************************
  ...
  public String getObracunLab()
 {
  ...
  {
    System.out.println("KORISTIM SG"); //XDEBUG delete when no more needed
    String opis ="";
    doprinosiNa.first();
    while(doprinosiNa.inBounds())
    {
...
//        opis += reformatStr(doprinosiR.getBigDecimal("IZNOS").toString());
  ...
  {
    String nazVro="";
    String cVro = frmRekObr.getFrmRekObr().getStaticFieldSet().getString("CVRO");
    ru.setDataSet(frmRekObr.getFrmRekObr().getStaticFieldSet());
    if(cVro.equals(""))
  ...
  public int getBrRad()
  {
    if(frmRekObr.getFrmRekObr().getStaticFieldSet().getString("CVRO").equals(""))
      return frmRekObr.getFrmRekObr().getbrDjelatnika("");
