...
public class repPotpListOJ implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  ...
  public repPotpListOJ() {
     ru.setDataSet(ds);
  }

  public repPotpListOJ(int idx) {
    ds.goToRow(idx);
  }
