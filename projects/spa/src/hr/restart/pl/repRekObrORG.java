...
public class repRekObrORG implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  DataSet ds = frmRekObr.getQdsORG();

  QueryDataSet doprinosiNa = frmRekObr.getDoprinosiNaORG();
  QueryDataSet doprinosiR = frmRekObr.getDoprinosiIzORG();
...
//******************** M O J I  P O D A C I ******************************
  ...
  public String getOJ()
 {
  ...
  public int getBrRad()
  {
    if(frmRekObr.getFrmRekObr().getStaticFieldSet().getString("CVRO").equals(""))
     return frmRekObr.getFrmRekObr().getbrDjelatnika(ds.getString("CORG"));
    return frmRekObr.getFrmRekObr().getbrDjelatnikaVRO(frmRekObr.getFrmRekObr().getStaticFieldSet().getString("CVRO"),
        ds.getString("CORG"));
  }
  ...
  public String getDoprinosiNaOpis()
  {
    String opis ="";
    doprinosiNa.first();
    System.out.println("DNACORGROWS: "+ doprinosiNa.getRowCount());
    int i = 0;
    while(doprinosiNa.inBounds())
    {
      System.out.println("OJ: " + this.getCOrg());
      System.out.println("CORG: " + doprinosiNa.getString("CORG"));
      if(doprinosiNa.getString("CORG").equals(this.getCOrg()))
      {
...
//          opis += reformatStr(doprinosiNa.getBigDecimal("IZNOS").toString());
  ...
  public String getDoprinosiIzOpis()
 {
   ...
   {
     if(doprinosiR.getString("CORG").equals(this.getCOrg()))
     {
 ...
 public String getDoprinosiRIznosi()
 {
   String opis ="";
   doprinosiR.first();
   while(doprinosiR.inBounds())
