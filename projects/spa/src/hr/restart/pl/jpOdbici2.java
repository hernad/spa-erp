...
public class jpOdbici2 extends JPanel {
  ...
  public jpOdbici2(raMatPodaci f) {
    try {
      fOdbici2 = f;
      jbInit();
    }
...
//    jlOznVal.setVisible(false);
    jbOznVal.setText("...");
    this.add(jlPnb2,    new XYConstraints(15, 25, -1, -1));
    this.add(jraPnb1,     new XYConstraints(150, 25, 100, -1));
    this.add(jraPnb2,     new XYConstraints(255, 25, 300, -1));
    this.add(jraIznos,   new XYConstraints(150, 50, 100, -1));
    this.add(jlIznos,   new XYConstraints(15, 50, -1, -1));
    this.add(jraStopa,   new XYConstraints(150, 50, 100, -1));
    this.add(jlStopa,   new XYConstraints(15, 50, -1, -1));
    this.add(jraRata,       new XYConstraints(455, 100, 100, -1));
    this.add(jraOznVal,        new XYConstraints(455, 125, 75, -1));
    this.add(jlSaldo,    new XYConstraints(15, 125, -1, -1));
    this.add(jraSaldo,    new XYConstraints(150, 125, 100, -1));
    this.add(jraDatpoc,     new XYConstraints(150, 75, 100, -1));
    this.add(jlDatpoc,     new XYConstraints(15, 75, -1, -1));
    this.add(jraDatzav,       new XYConstraints(455, 75, 100, -1));
    this.add(jlGlavnica,    new XYConstraints(15, 100, -1, -1));
    this.add(jraGlavnica,     new XYConstraints(150, 100, 100, -1));
    this.add(jlDatzav,      new XYConstraints(360, 75, -1, -1));
    this.add(jlRata,     new XYConstraints(360, 100, -1, -1));
    this.add(jraRBROdb,   new XYConstraints(150, 0, 50, -1));
    this.add(jlRBROdb,  new XYConstraints(15, 0, -1, -1));
    this.add(jlOznVal,    new XYConstraints(360, 125, -1, -1));
    this.add(jbOznVal,   new XYConstraints(534, 126, 21, 21));
