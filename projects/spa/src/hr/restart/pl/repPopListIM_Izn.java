...
public class repPopListIM_Izn implements sg.com.elixir.reportwriter.datasource.IDataProvider{
  _Main main;
  ...
  public repPopListIM_Izn() {
     ru.setDataSet(ds);
  }

  public repPopListIM_Izn(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    ...
    public Object nextElement() {
      return new repPopListIM_Izn(indx++);
    }
