...
public class repRekDopPorDOPRO implements sg.com.elixir.reportwriter.datasource.IDataProvider {

  hr.restart.robno._Main main;
  frmRekDopPor frdp = frmRekDopPor.getFrmRekDopPor();
  DataSet ds = frdp.getRepQDS02();
  ...
  public repRekDopPorDOPRO() {
    ru.setDataSet(ds);
  }

  public repRekDopPorDOPRO(int idx) {
    ds.goToRow(idx);
  }
  ...
  public java.util.Enumeration getData() {
    return new java.util.Enumeration() {
    {
      ...
      public Object nextElement() {
        ...
        return new repRekDopPorDOPRO(indx++);
      }
  ...
  public int getBROJRADNIKA(){
    return frdp.getBrojDjelatnika("LDPR");
  }
